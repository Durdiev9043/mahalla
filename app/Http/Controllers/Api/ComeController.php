...
//                $longitude2 = Location::where('village_id', $user->village_id)->first()->lang;
    ...
    public function bandlik(Request $request)
    {
        $user = User::where('id', $request->user_id)->first();
        $dd = Daily::where('user_id', $user->id)->where('day',Carbon::today())->first();
        //created_at->format('d.m.Y')  == Carbon::now()->format('d.m.Y')
...
//                    'filename' => $image2->getClientOriginalName(),
            ...
            if (isset($data['confidence']) && $data['confidence'] > 80) {
                ...
                $latitude1 = $request->lat;
                $longitude1 = $request->lang;
                $latitude2=Location::where('district_id',$user->district_id)->where('type',2)->first()->lat;
                $longitude2=Location::where('district_id',$user->district_id)->where('type',2)->first()->lang;
//                $latitude2 = Location::where('village_id', $user->village_id)->first()->lat;
//                $longitude2 = Location::where('village_id', $user->village_id)->first()->lang;
                if (($latitude1 == $latitude2) && ($longitude1 == $longitude2)) {
                    $data = Daily::create([
    ...
    public function ijtimoyi(Request $request)
    {
        $user = User::where('id', $request->user_id)->first();
        $dd = Daily::where('user_id', $user->id)->where('day',Carbon::today())->first();
        //created_at->format('d.m.Y')  == Carbon::now()->format('d.m.Y')
...
//                    'filename' => $image2->getClientOriginalName(),
            ...
            if (isset($data['confidence']) && $data['confidence'] > 80) {
                ...
                $latitude1 = $request->lat;
                $longitude1 = $request->lang;
                $latitude2=Location::where('district_id',$user->district_id)->where('type',3)->first()->lat;
                $longitude2=Location::where('district_id',$user->district_id)->where('type',3)->first()->lang;
//                $latitude2 = Location::where('village_id', $user->village_id)->first()->lat;
//                $longitude2 = Location::where('village_id', $user->village_id)->first()->lang;
                if (($latitude1 == $latitude2) && ($longitude1 == $longitude2)) {
                    $data = Daily::create([
